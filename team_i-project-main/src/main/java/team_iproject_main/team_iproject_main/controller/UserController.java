package team_iproject_main.team_iproject_main.controller;
...
public class UserController {
    ...
    public String portfolioedit(HttpSession session,PortfolioEditRequest edit) {
        String email = String.valueOf(session.getAttribute("email"));
        userService.portfolioupdate(edit,email);

        return "redirect:/portfolio_edit";
    }
    @GetMapping("/portfolio_edit")
    public String portfolioForm(HttpSession session) {
